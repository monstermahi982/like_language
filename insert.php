...
if(isset($_POST['done'])){
 ...
 $q = " INSERT INTO `crudtable`(`name`, `language`, `phone`, `email`, `description`) VALUES ( '$name', '$language', '$phone', '$email', '$description' )";
...
<body >
 ...
 <h1 class="text-white text-center">  Monster World </h1>
 </div>
 
 <a href="display.php" style="text-align: right; color: darkred;" >DATABASE</a>
